...
class ModflowSfr2(Package):
    ...
    def export(self, f, **kwargs):
        if isinstance(f, str) and f.lower().endswith(".shp"):
            from QSWATMOD2.modules.flopy.utils.geometry import Polygon
            ...
            from QSWATMOD2.modules.flopy import export
    ...
    def export_outlets(self, f, **kwargs):
        ...
        """
        from QSWATMOD2.modules.flopy.utils.geometry import Point
        from QSWATMOD2.modules.flopy.export.shapefile_utils import recarray2shp
        rd = self.reach_data
